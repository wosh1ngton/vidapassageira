                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 520px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0, 0, 0, 0.08);">
                    ...
                    <tr>
                        <td style="padding: 40px 32px;">
                            <h2 style="color: #333333; font-size: 20px; font-weight: 700; margin: 0 0 16px; text-align: center;">Redefinir senha</h2>

                            <p style="color: #666666; font-size: 15px; line-height: 1.6; margin: 0 0 8px;">Ol&#225;<#if user.firstName?has_content>, ${user.firstName}</#if>!</p>

                            <p style="color: #666666; font-size: 15px; line-height: 1.6; margin: 0 0 28px;">Recebemos uma solicita&#231;&#227;o para redefinir a senha da sua conta no <strong>VidaPassageira</strong>. Clique no bot&#227;o abaixo para criar uma nova senha.</p>
                            ...
                            <!-- Security note -->
                            <hr style="border: none; border-top: 1px solid #e8e8e8; margin: 28px 0;">
                            <p style="color: #999999; font-size: 13px; line-height: 1.6; margin: 0;">Se voc&#234; n&#227;o solicitou a redefini&#231;&#227;o de senha, ignore este email. Sua senha atual continuar&#225; funcionando normalmente.</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 24px 32px; border-top: 1px solid #e8e8e8; text-align: center;">
                            <p style="color: #bbbbbb; font-size: 12px; margin: 0;">&copy; VidaPassageira</p>
                        </td>
                    </tr>
